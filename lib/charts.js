...
function renderChart(width, height, backgroundColor, globalDefaults, untrustedChart) {
  let chart;
  ...
  const canvasRenderService = new CanvasRenderService(width, height, ChartJS => {
    ChartJS.defaults.global = deepmerge(ChartJS.defaults.global, globalDefaults);
  });
